...
export const TensorElementNode = memo(({ id, data, selected }: { id: string, data: NeuronNodeData, selected?: boolean }) => {
            ...
            <div className="p-3">
                <div className="flex items-center gap-2 mb-2">
                    ...
                    <div className="flex flex-col">
                        <span className="text-xs font-bold text-slate-300 uppercase tracking-wider">{data.neuron.label || 'Elem-Op'}</span>
